...
// де зберігається файл бази даних
const DB_FILE = process.env.DB_PATH || path.join(__dirname, 'brand.db');

const _db = new Database(DB_FILE);

// node-sqlite3-wasm приймає масив параметрів, а better-sqlite3 — variadic args
// ця обгортка робить API сумісним
const db = {
